...
const UI = {
  ...
  showSection(id) {
    ...
    if (target) {
      ...
      if (id === 'muro') this.initGlobalWall();
  ...
  async initGlobalWall() {
    ...
    container.innerHTML = `
      <div class="py-12 text-center">
        ...
        <p class="mt-4 text-slate-400 font-medium">Cargando todas las publicaciones...</p>
      </div>
    `;
    ...
    try {
      ...
      if (!posts || posts.length === 0) {
        container.innerHTML = Helpers.emptyState('No hay publicaciones en el muro aún.', 'layout');
        return;
      }
        ...
        return `
          <div class="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden hover:shadow-md transition-all duration-300 mb-6">
            <div class="p-5">
              ...
              <div class="text-slate-700 leading-relaxed mb-4 whitespace-pre-wrap">${p.content}</div>
