...
const DirectorUI = {
  ...
  renderDashboard(data) {
    ...
    // 🎂 Cumpleaños próximos de estudiantes
    _renderStaffBirthdayBanner();
...
// 🎂 Render banner de cumpleaños próximos para staff (directora/maestra/asistente)
async function _renderStaffBirthdayBanner() {
