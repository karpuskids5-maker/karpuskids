  ...
  -- ── CONVERSATION_PARTICIPANTS: permisivo (sin auto-referencia) ──
  -- NOTA: La política anterior causaba recursión infinita con messages_all.
  --       La seguridad real la controla messages_all (verifica membresía).
